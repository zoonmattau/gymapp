...
export const GOAL_INFO = {
  bulk: {
    ...
    requirements: [
      { title: 'Calorie Surplus', desc: 'Eat 300-500 calories above maintenance.' },
      { title: 'Heavy Training', desc: 'Focus on compound lifts with progressive overload.' },
      { title: 'High Protein', desc: 'Aim for 1.8-2.2g protein per kg bodyweight.' },
      { title: 'Recovery', desc: 'Sleep 7-9 hours for optimal muscle growth.' },
    ],
    minDays: 4,
    idealDays: '4-6',
  ...
  bodybuilding: {
    ...
    requirements: [
      { title: 'Isolation Focus', desc: 'Target each muscle group with dedicated sessions.' },
      { title: 'High Volume', desc: 'Multiple exercises per muscle group each session.' },
      { title: 'High Protein', desc: 'Aim for 1.8-2.2g protein per kg bodyweight.' },
      { title: 'Recovery', desc: 'Each muscle gets 6-7 days rest between sessions.' },
    ],
    minDays: 5,
    idealDays: '5-6',
    weightDirection: 'gain',
  ...
  build_muscle: {
    ...
    requirements: [
      { title: 'Progressive Overload', desc: 'Gradually increase weight, reps, or sets.' },
      { title: 'Consistency', desc: 'Results come from stacking sessions week after week.' },
      { title: 'Protein-Rich Diet', desc: 'Aim for 1.6-2.2g protein per kg bodyweight.' },
      { title: 'Quality Sleep', desc: '7-9 hours per night for muscle repair.' },
    ],
    minDays: 3,
    idealDays: '4-5',
    weightDirection: 'gain',
  ...
  strength: {
    ...
    requirements: [
      { title: 'Heavy Compounds', desc: 'Focus on squat, bench, deadlift, overhead press.' },
      { title: 'Low Reps, High Weight', desc: '1-6 rep range with heavy loads.' },
      { title: 'Rest Periods', desc: 'Take 3-5 minutes rest between heavy sets.' },
    ],
    minDays: 3,
    idealDays: '3-4',
  ...
  recomp: {
    ...
    requirements: [
      { title: 'Maintenance Calories', desc: 'Eat at or slightly below TDEE.' },
      { title: 'Very High Protein', desc: 'Aim for 2.0-2.4g protein per kg bodyweight.' },
      { title: 'Heavy Training', desc: 'Prioritize strength training to preserve muscle.' },
      { title: 'Patience', desc: 'This approach is slower but sustainable.' },
    ],
    minDays: 3,
    idealDays: '4-5',
    weightDirection: 'maintain',
  ...
  fitness: {
    ...
    requirements: [
      { title: 'Variety', desc: 'Mix resistance training, cardio, and flexibility.' },
      { title: 'Heart Health', desc: '150 mins moderate cardio per week minimum.' },
      { title: 'Mobility', desc: 'Include stretching and mobility work.' },
    ],
    minDays: 2,
    idealDays: '3-5',
    weightDirection: 'maintain',
  ...
  athletic: {
    ...
    requirements: [
      { title: 'Conditioning', desc: 'Mix strength with sport-specific cardio.' },
      { title: 'Speed & Power', desc: 'Include plyometrics and explosive movements.' },
      { title: 'Mobility', desc: 'Prioritize flexibility and injury prevention.' },
    ],
    minDays: 3,
    idealDays: '4-5',
    weightDirection: 'maintain',
  ...
  lean: {
    ...
    requirements: [
      { title: 'Moderate Deficit', desc: 'Eat 300-400 calories below maintenance.' },
      { title: 'High Protein', desc: 'Keep protein at 2.0g+ per kg to preserve muscle.' },
      { title: 'Maintain Intensity', desc: 'Keep lifting heavy to signal muscle retention.' },
    ],
    minDays: 3,
    idealDays: '4-5',
  ...
  lose_fat: {
    ...
    requirements: [
      { title: 'Calorie Deficit', desc: 'Eat 500-750 calories below maintenance.' },
      { title: 'Cardio + Weights', desc: 'Combine resistance training with cardio.' },
      { title: 'Very High Protein', desc: 'Maximize protein to preserve muscle mass.' },
    ],
    minDays: 3,
    idealDays: '4-6',
    weightDirection: 'lose',
